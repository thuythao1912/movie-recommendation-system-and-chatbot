...
class CollaborativeFilter:
    ...
    def run(self):
        ...
        data_sample = pd.read_csv(os.path.join(root, "data", "raw_data", "rating_for_testing.csv"), sep=',', names=r_cols)
        ...
        # print(data)
        # print(data_sample)
        rate_train = data_sample.values #choose data or data_sample
    ...
    def calculate_accuracy(self):
        ...
        ratings_test = pd.read_csv(os.path.join(root, "data", "raw_data", "rating_for_testing.csv"), sep=',', names=r_cols)
...
if __name__ == "__main__":
    ...
    rs = CollaborativeFilter(k=2, uuCF=1)
    print(rs.recommend_for_user("1"))
    print(rs.recommend_for_user("2"))
    print(rs.recommend_for_user("3"))
    print(rs.recommend_for_user("4"))
    print(rs.recommend_for_user("5"))
    print(rs.recommend_for_user("6"))
